    ...
    <Section id="skills" index="05" zh="技能" en="SKILLS & TOOLS" dark>
      <div className="col-span-12 mt-[2vh] flex justify-center">
        <div className="mx-[-50%] flex w-screen flex-col gap-2">
          <MarqueeRow className="border-ink font-disp text-fluid-3xl text-ink bg-acid rotate-fluid-4 border-y-3 py-4 tracking-wider">
            <MarqueeBlock
          ...
          <MarqueeRow
            className="border-paper bg-ink font-disp text-fluid-3xl text-stroke-paper text-stroke-1.5 -rotate-fluid-4 border-y-3 py-4 tracking-wider text-transparent"
            reverse
          >
            <MarqueeBlock
          ...
          <MarqueeRow className="border-ink bg-scarlet font-disp text-fluid-3xl text-paper rotate-fluid-4 border-y-3 py-4 tracking-wider">
            <MarqueeBlock
      ...
      <Reveal className="text-fluid-2xl col-span-8 leading-normal font-black">
        技能清单谁都会写，
        <br />
