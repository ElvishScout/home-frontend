    ...
    <section id="skills" className="relative bg-ink py-[16vh] pb-[14vh] text-paper">
      ...
      <div className="mt-[2vh] flex flex-col gap-5.5">
        <MarqueeRow
          ...
          itemClassName="inline-flex items-center gap-9 px-9 font-disp text-fluid-9 tracking-wider text-ink"
        ...
        <MarqueeRow
          ...
          trackClassName="[animation-duration:26s]"
          itemClassName="inline-flex items-center gap-9 px-9 font-disp text-fluid-9 tracking-wider text-paper"
